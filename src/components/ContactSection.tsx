...
export default function ContactSection() {
    ...
    return (
        <section id="contact" className="py-24 sm:py-32 relative overflow-hidden bg-surface-alt">
            <motion.div
                animate={{
                    scale: [1, 1.2, 1],
                    opacity: [0.3, 0.5, 0.3]
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            >
                                ...
                                <span className="text-foreground font-medium">balanvictor1567@gmail.com</span>
                            </a>
                            <button
                                onClick={copyEmail}
                        ...
                        >
                            ...
                            <span className="text-foreground font-medium">(+40) 787722414</span>
                        </motion.a>
                    </div>
